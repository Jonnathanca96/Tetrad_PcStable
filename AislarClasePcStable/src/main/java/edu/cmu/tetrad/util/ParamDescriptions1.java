 ...
 * @author jdramsey
 */
public class ParamDescriptions1 {

    private static ParamDescriptions1 instance = new ParamDescriptions1();
    private Map<String, ParamDescription> map = new HashMap<>();

    public ParamDescriptions1() {
...
//        put("useRuleC", new ParamDescription("Yes if rule C for CCD should be used", false));
    ...
    public static ParamDescriptions1 instance() {
        return instance;
    }
